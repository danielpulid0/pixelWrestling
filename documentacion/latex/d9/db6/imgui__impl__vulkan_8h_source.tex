...
\DoxyCodeLine{00077\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structImGui__ImplVulkan__InitInfo}{ImGui\_ImplVulkan\_InitInfo}}}
\DoxyCodeLine{00078\ \{}
...
\DoxyCodeLine{00112\ IMGUI\_IMPL\_API\ \textcolor{keywordtype}{bool}\ \ \ \ \ \ \ \ \ \ \ \ \ ImGui\_ImplVulkan\_Init(\doxymbox{\hyperlink{structImGui__ImplVulkan__InitInfo}{ImGui\_ImplVulkan\_InitInfo}}*\ info);}
...
\DoxyCodeLine{00115\ IMGUI\_IMPL\_API\ \textcolor{keywordtype}{void}\ \ \ \ \ \ \ \ \ \ \ \ \ ImGui\_ImplVulkan\_RenderDrawData(\doxymbox{\hyperlink{structImDrawData}{ImDrawData}}*\ draw\_data,\ VkCommandBuffer\ command\_buffer,\ VkPipeline\ pipeline\ =\ VK\_NULL\_HANDLE);}
...
\DoxyCodeLine{00133\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structImGui__ImplVulkan__RenderState}{ImGui\_ImplVulkan\_RenderState}}}
\DoxyCodeLine{00134\ \{}
...
\DoxyCodeLine{00161\ }
\DoxyCodeLine{00162\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structImGui__ImplVulkanH__Frame}{ImGui\_ImplVulkanH\_Frame}};}
\DoxyCodeLine{00163\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structImGui__ImplVulkanH__Window}{ImGui\_ImplVulkanH\_Window}};}
\DoxyCodeLine{00164\ }
\DoxyCodeLine{00165\ \textcolor{comment}{//\ Helpers}}
\DoxyCodeLine{00166\ IMGUI\_IMPL\_API\ \textcolor{keywordtype}{void}\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ImGui\_ImplVulkanH\_CreateOrResizeWindow(VkInstance\ instance,\ VkPhysicalDevice\ physical\_device,\ VkDevice\ device,\ \doxymbox{\hyperlink{structImGui__ImplVulkanH__Window}{ImGui\_ImplVulkanH\_Window}}*\ wd,\ uint32\_t\ queue\_family,\ \textcolor{keyword}{const}\ VkAllocationCallbacks*\ allocator,\ \textcolor{keywordtype}{int}\ w,\ \textcolor{keywordtype}{int}\ h,\ uint32\_t\ min\_image\_count);}
\DoxyCodeLine{00167\ IMGUI\_IMPL\_API\ \textcolor{keywordtype}{void}\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ImGui\_ImplVulkanH\_DestroyWindow(VkInstance\ instance,\ VkDevice\ device,\ \doxymbox{\hyperlink{structImGui__ImplVulkanH__Window}{ImGui\_ImplVulkanH\_Window}}*\ wd,\ \textcolor{keyword}{const}\ VkAllocationCallbacks*\ allocator);}
...
\DoxyCodeLine{00177\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structImGui__ImplVulkanH__Frame}{ImGui\_ImplVulkanH\_Frame}}}
\DoxyCodeLine{00178\ \{}
...
\DoxyCodeLine{00185\ \};}
\DoxyCodeLine{00186\ }
\DoxyCodeLine{00187\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structImGui__ImplVulkanH__FrameSemaphores}{ImGui\_ImplVulkanH\_FrameSemaphores}}}
\DoxyCodeLine{00188\ \{}
...
\DoxyCodeLine{00211\ \ \ \ \ \doxymbox{\hyperlink{structImVector}{ImVector<ImGui\_ImplVulkanH\_Frame>}}\ \ \ \ \ \ \ \ \ \ \ Frames;}
\DoxyCodeLine{00212\ \ \ \ \ \doxymbox{\hyperlink{structImVector}{ImVector<ImGui\_ImplVulkanH\_FrameSemaphores>}}\ FrameSemaphores;}
\DoxyCodeLine{00213\ }
