\chapter{BACKENDS }
\hypertarget{md_build_2__deps_2imgui-src_2docs_2BACKENDS}{}\label{md_build_2__deps_2imgui-src_2docs_2BACKENDS}\index{BACKENDS@{BACKENDS}}
{\itshape (You may browse this at \href{https://github.com/ocornut/imgui/blob/master/docs/BACKENDS.md}{\texttt{https:\+/\+/\+github.\+com/\+ocornut/\+imgui/\+blob/\+master/\+docs/\+\+BACKENDS.\+md}} or view this file with any Markdown viewer)}\hypertarget{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md17}{}\doxysubsection{\texorpdfstring{Dear Im\+Gui:\+ Backends}{Dear Im\+Gui:\+ Backends}}\label{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md17}
\hypertarget{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md18}{}\doxysubsubsection{\texorpdfstring{Integrating backends}{Integrating backends}}\label{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md18}
💡 The {\bfseries{\href{https://github.com/ocornut/imgui/wiki/Getting-Started}{\texttt{Getting Started}} wiki guide}} has examples of how to integrate Dear Im\+Gui into an existing application. ~\newline
 The \href{https://github.com/ocornut/imgui/blob/master/docs/EXAMPLES.md}{\texttt{EXAMPLES.\+MD}} documentation may also be worth a read.\hypertarget{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md19}{}\doxysubsubsection{\texorpdfstring{What are backends?}{What are backends?}}\label{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md19}
...
\end{DoxyItemize}\hypertarget{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md20}{}\doxysubsubsection{\texorpdfstring{Standard backends}{Standard backends}}\label{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md20}
...
{\bfseries{Once Dear Im\+Gui is setup and running, run and refer to {\ttfamily Im\+Gui::\+\+Show\+Demo\+Window()} in imgui\+\_\+demo.\+cpp for usage of the end-\/user API.}}\hypertarget{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md21}{}\doxysubsubsection{\texorpdfstring{List of backends}{List of backends}}\label{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md21}
...
Emscripten is also supported! The SDL+\+GL, GLFW+\+GL and GLFW+\+Web\+GPU examples are all ready to build and run with Emscripten.\hypertarget{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md22}{}\doxysubsubsection{\texorpdfstring{Backends for third-\/party frameworks, graphics API or other languages}{Backends for third-\/party frameworks, graphics API or other languages}}\label{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md22}
See \href{https://github.com/ocornut/imgui/wiki/Bindings}{\texttt{https:\+/\+/\+github.\+com/\+ocornut/\+imgui/\+wiki/\+\+Bindings}} for the full list (e.\+g. Adventure Game Studio, Cinder, Cocos2d-\/x, Game Maker Studio2, Godot, LÖ\+VE+\+LUA, Magnum, Monogame, Ogre, open\+Frameworks, Open\+Scene\+Graph, SFML, Sokol, Unity, Unreal Engine and many others).\hypertarget{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md23}{}\doxysubsubsection{\texorpdfstring{Recommended Backends}{Recommended Backends}}\label{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md23}
...
\end{DoxyTable}
\hypertarget{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md24}{}\doxysubsubsection{\texorpdfstring{Using a custom engine?}{Using a custom engine?}}\label{md_build_2__deps_2imgui-src_2docs_2BACKENDS_autotoc_md24}
...
Also:\+ The \href{https://github.com/ocornut/imgui/wiki/Multi-Viewports}{\texttt{multi-\/viewports feature}} of the \textquotesingle{}docking\textquotesingle{} branch allows Dear Im\+Gui windows to be seamlessly detached from the main application window. This is achieved using an extra layer to the Platform and Renderer backends, which allows Dear Im\+Gui to communicate platform-\/specific requests such as:\+ "{}create an additional OS window"{}, "{}create a render context"{}, "{}get the OS position of this window"{} etc. See \textquotesingle{}\doxylink{structImGuiPlatformIO}{Im\+Gui\+Platform\+IO}\textquotesingle{} for details. Supporting the multi-\/viewports feature correctly using 100\% of your own abstractions is more difficult than supporting single-\/viewport. If you decide to use unmodified imgui\+\_\+impl\+\_\+\+XXXX.\+cpp files, you can automatically benefit from improvements and fixes related to viewports and platform windows without extra work on your side. 